...
// 然而，你不能在没有获得钥匙的时候进入锁住的房间。当你进入一个房间，你可能会在里面找到一套不同的钥匙，
...
//    }
//
//    public void dfs(List<List<Integer>> rooms, int roomId) {
//        visited[roomId] = true;
//        roomNum++;
//        for (int i: rooms.get(roomId)) {
//            if (!visited[i]) {
//                dfs(rooms, i);
//            }
//        }
