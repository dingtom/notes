- [PyQt5是由一系列Python模块组成。超过620个类，6000函数和方法。能在诸如Unix、Windows和Mac OS等主流操作系统上运行。PyQt5有两种证书，GPL和商业证书。](#head1)
	- [ 例1，简单的窗口](#head2)
	- [ 例2，带窗口图标](#head3)
	- [ 例3，提示框](#head4)
	- [ 例4，关闭窗口](#head5)
