- [第一章 Redis基础](#head1)
	...
	- [1. Redis 简介](#head3)
		- [1.1 NoSQL概念](#head4)
			- [1.1.1 问题现象](#head5)
			- [1.1.2 NoSQL的概念](#head6)
		- [1.2 Redis概念](#head7)
			- [1.2.1 redis概念](#head8)
			- [1.2.2 redis的应用场景](#head9)
		- [1.3 Redis 的下载与安装](#head10)
			- [1.3.1 Redis 的下载与安装](#head11)
		- [1.4 Redis服务器启动](#head12)
			- [1.4.1 Redis服务器启动](#head13)
			- [1.4.2 Redis客户端启动](#head14)
			- [1.4.3 Redis基础环境设置约定](#head15)
		- [1.5 配置文件启动与常用配置](#head16)
			- [1.5.1 服务器端设定](#head17)
			- [1.5.2  客户端配置](#head18)
			- [1.5.3  日志配置](#head19)
		- [1.6 Redis基本操作](#head20)
			- [1.6.1  命令行模式工具使用思考](#head21)
			- [1.6.2  信息读写](#head22)
			- [1.6.3  帮助信息](#head23)
			- [1.6.4  redis入门总结](#head24)
	- [2. 数据类型](#head25)
		- [2.1  数据存储类型介绍](#head26)
			- [2.1.1  业务数据的特殊性](#head27)
			- [2.1.2  Redis 数据类型(5种常用)](#head28)
		- [2.2  string数据类型](#head29)
			- [2.2.1Redis 数据存储格式](#head30)
			- [2.2.2  string 类型](#head31)
			- [2.2.3  string 类型数据的基本操作](#head32)
		- [2.3  string 类型数据的扩展操作](#head33)
			- [2.3.1  string 类型数据的扩展操作](#head34)
			- [2.3.2  string 类型数据操作的注意事项](#head35)
		- [ 2.4string应用场景与key命名约定](#head36)
			- [2.4.1  应用场景](#head37)
			- [2.4.2  解决方案](#head38)
		- [2.5  hash的基本操作](#head39)
			- [2.5.1  数据存储的困惑](#head40)
			- [2.5.2  hash 类型](#head41)
			- [2.5.3  hash 类型数据的基本操作](#head42)
		- [2.6  hash的拓展操作](#head43)
			- [2.6.1  hash 类型数据扩展操作](#head44)
			- [2.6.2  hash类型数据操作的注意事项](#head45)
		- [2.7  hash应用场景](#head46)
			- [2.7.1  应用场景](#head47)
			- [2.7.2  解决方案](#head48)
		- [2.8  list基本操作](#head49)
			- [2.8.1  list 类型](#head50)
			- [2.8.2 list 类型数据基本操作](#head51)
		- [2.9  list扩展操作](#head52)
			- [2.9.1  list 类型数据扩展操作](#head53)
			- [2.9.2  list 类型数据操作注意事项](#head54)
		- [2.10 list 应用场景](#head55)
			- [2.10.1  应用场景](#head56)
			- [2.10.2  解决方案](#head57)
		- [2.11  set 基本操作](#head58)
			- [2.11.1 set类型](#head59)
			- [2.11.2 set类型数据的基本操作](#head60)
		- [2.12  set 类型数据的扩展操作](#head61)
			- [2.12.1  set 类型数据的扩展操作](#head62)
			- [2.12.2  set 类型数据操作的注意事项](#head63)
		- [2.13  set应用场景](#head64)
			- [2.13.2  解决方案](#head65)
	- [3. 常用指令](#head66)
		- [3.1  key 操作分析](#head67)
			- [3.1.1  key应该设计哪些操作？](#head68)
			- [3.1.2  key 基本操作](#head69)
			- [3.1.3  key 扩展操作（时效性控制）](#head70)
			- [3.1.4  key 扩展操作（查询模式）](#head71)
		- [3.2  数据库指令](#head72)
			- [3.2.1  key 的重复问题](#head73)
			- [3.2.2  解决方案](#head74)
			- [3.2.3   数据库的基本操作](#head75)
			- [3.2.4  数据库扩展操作](#head76)
	- [4. Jedis](#head77)
		- [4.1  Jedis简介](#head78)
			- [4.1.1  编程语言与redis](#head79)
			- [4.1.2  准备工作](#head80)
			- [4.1.3 代码实现](#head81)
		- [4.2  Jedis简易工具类开发](#head82)
			- [4.2.1  基于连接池获取连接](#head83)
			- [4.2.2  封装连接参数](#head84)
			- [4.2.3  加载配置信息](#head85)
			- [4.2.4  获取连接](#head86)
		- [4.3  可视化客户端](#head87)
	- [5. 持久化](#head88)
		- [5.1  持久化简介](#head89)
			- [5.1.1  场景-意外断电](#head90)
			- [5.1.2  什么是持久化](#head91)
		- [5.2  RDB](#head92)
			- [5.2.1  save指令](#head93)
			- [5.2.2  bgsave指令](#head94)
			- [5.2.3 save配置自动执行](#head95)
			- [5.2.4 RDB三种启动方式对比](#head96)
		- [5.3  AOF](#head97)
			- [5.3.1 AOF概念](#head98)
			- [5.3.2 AOF执行策略](#head99)
			- [5.3.3 AOF重写](#head100)
			- [5.3.4 AOF工作流程及重写流程](#head101)
		- [5.4  RDB与AOF区别](#head102)
			- [5.4.1 RDB与AOF对比（优缺点）](#head103)
			- [5.4.2 RDB与AOF应用场景](#head104)


# <span id="head1">第一章 Redis基础</span>
...
### <span id="head4">1.1 NoSQL概念</span>

#### <span id="head5">1.1.1 问题现象</span>
...
#### <span id="head6">1.1.2 NoSQL的概念</span>
...
### <span id="head7">1.2 Redis概念</span>

#### <span id="head8">1.2.1 redis概念</span>
...
#### <span id="head9">1.2.2 redis的应用场景</span>
...
### <span id="head10">1.3 Redis 的下载与安装</span>

后期所有资料分4中不同色块显示，详情如下：

![](img\约定格式.png)

#### <span id="head11">1.3.1 Redis 的下载与安装</span>
...
### <span id="head12">1.4 Redis服务器启动</span>

#### <span id="head13">1.4.1 Redis服务器启动</span>
...
#### <span id="head14">1.4.2 Redis客户端启动</span>
...
#### <span id="head15">1.4.3 Redis基础环境设置约定</span>
...
### <span id="head16">1.5 配置文件启动与常用配置</span>

#### <span id="head17">1.5.1 服务器端设定</span>
...
#### <span id="head18">1.5.2  客户端配置</span>
...
#### <span id="head19">1.5.3  日志配置</span>
...
### <span id="head20">1.6 Redis基本操作</span>

#### <span id="head21">1.6.1  命令行模式工具使用思考</span>
...
#### <span id="head22">1.6.2  信息读写</span>
...
#### <span id="head23">1.6.3  帮助信息</span>
...
#### <span id="head24">1.6.4  redis入门总结</span>
...
#### <span id="head31">2.2.2  string 类型</span>
...
#### <span id="head32">2.2.3  string 类型数据的基本操作</span>
...
### <span id="head33">2.3  string 类型数据的扩展操作</span>

#### <span id="head34">2.3.1  string 类型数据的扩展操作</span>
...
#### <span id="head35">2.3.2  string 类型数据操作的注意事项</span>
...
### <span id="head36"> 2.4string应用场景与key命名约定</span>

#### <span id="head37">2.4.1  应用场景</span>
...
#### <span id="head38">2.4.2  解决方案</span>
...
### <span id="head39">2.5  hash的基本操作</span>

下面我们来学习第二个数据类型hash。

#### <span id="head40">2.5.1  数据存储的困惑</span>
...
#### <span id="head41">2.5.2  hash 类型</span>
...
#### <span id="head42">2.5.3  hash 类型数据的基本操作</span>

添加/修改数据

```bash
hset key field value
hset user:123 name itcast
hset user:123 age 12
```
...
### <span id="head43">2.6  hash的拓展操作</span>

在看完hash的基本操作后，我们再来看他的拓展操作，他的拓展操作相对比较简单：

#### <span id="head44">2.6.1  hash 类型数据扩展操作</span>
...
#### <span id="head45">2.6.2  hash类型数据操作的注意事项</span>
...
### <span id="head46">2.7  hash应用场景</span>

#### <span id="head47">2.7.1  应用场景</span>
...
#### <span id="head48">2.7.2  解决方案</span>
...
### <span id="head49">2.8  list基本操作</span>
...
#### <span id="head50">2.8.1  list 类型</span>

数据存储需求：**存储多个数据，并对数据进入存储空间的顺序进行区分**

需要的存储结构：一个存储空间保存多个数据，且通过数据可以体现进入顺序

list类型：保存多个数据，底层使用**双向链表存储结构实现**
...
#### <span id="head51">2.8.2 list 类型数据基本操作</span>
...
### <span id="head52">2.9  list扩展操作</span>

#### <span id="head53">2.9.1  list 类型数据扩展操作</span>

移除指定数据

```
lrem key count value
lrem list 1 zhangsan
```
...
#### <span id="head54">2.9.2  list 类型数据操作注意事项</span>
...
### <span id="head55">2.10 list 应用场景</span>

#### <span id="head56">2.10.1  应用场景</span>
...
#### <span id="head57">2.10.2  解决方案</span>
...
### <span id="head58">2.11  set 基本操作</span>

#### <span id="head59">2.11.1 set类型</span>
...
#### <span id="head60">2.11.2 set类型数据的基本操作</span>
...
### <span id="head61">2.12  set 类型数据的扩展操作</span>

#### <span id="head62">2.12.1  set 类型数据的扩展操作</span>
...
#### <span id="head63">2.12.2  set 类型数据操作的注意事项</span>

**set 类型不允许数据重复**，如果添加的数据在 set 中已经存在，将只保留一份。

set 虽然与hash的存储结构相同，但是无法启用hash中存储值的空间。

### <span id="head64">2.13  set应用场景</span>

（1）黑名单、白名单维护（过滤重复）

对于安全性更高的应用访问，仅仅靠黑名单是不能解决安全问题的，此时需要设定可访问的用户群体， 依赖白名单做更为苛刻的访问验证。

#### <span id="head65">2.13.2  解决方案</span>
...
### <span id="head67">3.1  key 操作分析</span>

#### <span id="head68">3.1.1  key应该设计哪些操作？</span>
...
#### <span id="head69">3.1.2  key 基本操作</span>
...
#### <span id="head70">3.1.3  key 扩展操作（时效性控制）</span>
...
#### <span id="head71">3.1.4  key 扩展操作（查询模式）</span>
...
it*             查询所有以it开头
*heima          查询所有以heima结尾
??heima    查询所有前面两个字符任意，后面以heima结尾 查询所有以
user:?     user:开头，最后一个字符任意
u[st]er:1  查询所有以u开头，以er:1结尾，中间包含一个字母，s或t
```

### <span id="head72">3.2  数据库指令</span>

#### <span id="head73">3.2.1  key 的重复问题</span>
...
#### <span id="head74">3.2.2  解决方案</span>
...
#### <span id="head75">3.2.3   数据库的基本操作</span>
...
#### <span id="head76">3.2.4  数据库扩展操作</span>
...
### <span id="head78">4.1  Jedis简介</span>

#### <span id="head79">4.1.1  编程语言与redis</span>
...
#### <span id="head80">4.1.2  准备工作</span>
...
#### <span id="head81">4.1.3 代码实现</span>
...
#### <span id="head84">4.2.2  封装连接参数</span>
...
#### <span id="head85">4.2.3  加载配置信息</span>
...
#### <span id="head86">4.2.4  获取连接</span>
...
### <span id="head87">4.3  可视化客户端</span>

4.3.1  Redis Desktop Manager

![](img\可视化.png)

## <span id="head88">5. 持久化</span>
...
### <span id="head89">5.1  持久化简介</span>

#### <span id="head90">5.1.1  场景-意外断电</span>
...
#### <span id="head91">5.1.2  什么是持久化</span>
...
### <span id="head92">5.2  RDB</span>

#### <span id="head93">5.2.1  save指令</span>
...
#### <span id="head94">5.2.2  bgsave指令</span>

之前我们讲到了当save指令的数据量过大时，单线程执行方式造成效率过低，那应该如何处理？

此时我们可以使用：**bgsave**指令，bg其实是background的意思，手动启动后台保存操作，但不是立即执行
...
#### <span id="head95">5.2.3 save配置自动执行</span>
...
#### <span id="head96">5.2.4 RDB三种启动方式对比</span>
...
- bgsave指令每次运行要执行**fork操作创建子进程**，要牺牲掉一些性能
- Redis的众多版本中未进行RDB文件格式的版本统一，有可能出现各版本服务之间数据格式**无法兼容现象**



### <span id="head97">5.3  AOF</span>

为什么要有AOF,这得从RDB的存储的弊端说起：

- 存储数据量较大，效率较低，基于**快照思想，每次读写都是全部数据**，当数据量巨大时，效率非常低，大数据量下的**IO性能较低**
- 基于**fork创建子进程**，内存产生额外消耗
- 宕机上一时间点存了，下一时间点没存， 带来的**数据丢失风险**
...
#### <span id="head98">5.3.1 AOF概念</span>
...
#### <span id="head99">5.3.2 AOF执行策略</span>
...
#### <span id="head100">5.3.3 AOF重写</span>
...
#### <span id="head101">5.3.4 AOF工作流程及重写流程</span>
...
### <span id="head102">5.4  RDB与AOF区别</span>

#### <span id="head103">5.4.1 RDB与AOF对比（优缺点）</span>
...
#### <span id="head104">5.4.2 RDB与AOF应用场景</span>
