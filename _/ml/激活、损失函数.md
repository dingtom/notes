- [Cross Entropy Loss](#head1)
- [ BCE](#head2)
- [Label Smoothing](#head3)
- [Focal Loss](#head4)
- [ Lovász-Softmax](#head5)
- [ 检测速度](#head6)


# <span id="head1">Cross Entropy Loss</span>
...
# <span id="head3">Label Smoothing</span>
...
# <span id="head5"> Lovász-Softmax</span>
